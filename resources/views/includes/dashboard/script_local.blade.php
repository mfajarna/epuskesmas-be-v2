      ...
      <script src="{{ url('assets/libs/bootstrap/js/bootstrap.bundle.min.j')}}s"></script>
      <script src="{{ url('assets/libs/metismenu/metisMenu.min.js')}}"></script>
      <script src="{{ url('assets/libs/simplebar/simplebar.min.js')}}"></script>
      <script src="{{ url('assets/libs/node-waves/waves.min.j')}}s"></script>
      <script src="{{ url('assets/libs/feather-icons/feather.min.js')}}"></script>
      <!-- pace js -->
      <script src="{{ url('assets/libs/pace-js/pace.min.js')}}"></script>

      <!-- apexcharts -->
      <script src="{{ url('assets/libs/apexcharts/apexcharts.min.j')}}s"></script>
