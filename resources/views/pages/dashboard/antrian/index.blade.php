...
@section('title', 'Manajemen Antrian Poli')
        ...
        $(document).ready(function(){
            ...
            t.on('click', '#btn_active', function() {
                $tr = $(this).closest('tr');
                    ...
                    $.ajax({
                        method: 'get',
                        url: '{{ route("admin.antrian.editstatus") }}',
